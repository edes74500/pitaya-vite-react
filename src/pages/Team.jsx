  ...
  return (
    <div className="team-container page-container">
      ...
      <div className="content-container">
        Notre équipe est constituée de 4 professionnelles spécialisées de la petite enfance, diplomées d'état, pour une complémentarité pertinente au
        service de l'enfant et sa famille Réunions d'équipe : prendre le temps de réfléchir en amont, d'échanger les idées, de penser des projets
        ...
        de responsabilités pour être impliqué dans la réussite de la micro-crèche Des projets à créer !
      </div>
    </div>
  );
};
